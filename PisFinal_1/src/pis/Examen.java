...
String[] respuestas;
    public Examen() {
        super("Exámen Cinturón Negro Primer Dan");
        initComponents();
        setResizable(false);
        ...
        question.setText(QuestCinNegro1Dan.get(0).getQuestion());
      
        buttonGroup1.clearSelection(); // sirve para borrar las selecciones de los radio button
        
          String[] res=new String[4];
   res[0]=QuestCinNegro1Dan.get(0).getRespuesta();
   res[1]=QuestCinNegro1Dan.get(0).getAlternativa1();
   res[2]=QuestCinNegro1Dan.get(0).getAlternativa2();
   res[3]=QuestCinNegro1Dan.get(0).getAlternativa3();
   ...
   orden[3]="";
    ...
    private void avanzarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_avanzarActionPerformed
        ...
        if(posicion < 12){
            ...
            posicion++;
            question.setText(QuestCinNegro1Dan.get(posicion).getQuestion());
           
            buttonGroup1.clearSelection(); // sirve para borrar las selecciones de los radio button
                   String[] res=new String[4];
   res[0]=QuestCinNegro1Dan.get(posicion).getRespuesta();
   res[1]=QuestCinNegro1Dan.get(posicion).getAlternativa1();
   res[2]=QuestCinNegro1Dan.get(posicion).getAlternativa2();
   res[3]=QuestCinNegro1Dan.get(posicion).getAlternativa3();
   String[] orden=new String[4];
   orden[0]="";
   orden[1]="";
   orden[2]="";
   ...
   orden[3]="";
    ...
    private void terminarExamenActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_terminarExamenActionPerformed
        ...
        for(int i = 0; i < 12; i++){
            if(respuestas[i].equals(QuestCinNegro1Dan.get(i).getRespuesta())){
